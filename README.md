...
`/restaurants` 收錄新竹市區、竹北與竹東各 5 間餐廳，可依下列條件交叉篩選：

- 地區：新竹市區、竹北、竹東
- 類型：日式、中式、小吃、宵夜、火鍋
- 每人預算：`NT$200`、`NT$500`、`NT$1,000`
- 時段：午餐、晚餐、深夜

每張餐廳卡片包含營業時間、概估價位、地址、交通建議、Google Maps 與資料來源。新增或調整餐廳後，請執行 `npm run test:regression`，確認三區數量、篩選邏輯與靜態頁面輸出仍一致。
