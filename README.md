...
`/restaurants` 收錄新竹市區、竹北、竹東與關埔・科學園區共 23 間餐廳，可依下列條件交叉篩選：

- 地區：新竹市區、竹北、竹東、關埔・園區
- 類型：日式、中式、小吃、宵夜、火鍋、泰式、印度
- 每人價位帶：`NT$200` 內、`NT$201–500`、`NT$501` 以上
- 時段：午餐、晚餐、深夜

每張餐廳卡片包含營業時間、概估價位、地址、交通建議、Google Maps 與資料來源；關埔・園區店家另附第三方平台評價快照。新增或調整餐廳後，請執行 `npm run test:regression`，確認區域數量、價位帶、篩選邏輯與靜態頁面輸出仍一致。
